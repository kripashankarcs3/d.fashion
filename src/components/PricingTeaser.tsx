...
const plans = [
  {
    ...
    features: ['Colour season analysis', '9 AI try-on images', 'Season identification'],
    featured: false,
    cta: 'Start Free',
    href: '/upload',
  },
  {
    name: 'Essentials',
    price: formatPrice(PLANS.find((p) => p.name === 'Essentials')?.monthly ?? 200),
    period: '/month',
    note: 'Most popular',
    features: ['Full colour report', '40 AI try-on images', 'Palette download', 'Makeup shade guide'],
    featured: true,
    cta: 'Get Essentials',
    href: '/pricing',
  },
  {
    ...
    features: ['Everything in Essentials', 'Unlimited AI try-ons', 'AI Stylist Chat', 'Priority support'],
    featured: false,
    cta: 'Go Atelier',
    href: '/pricing',
  },
