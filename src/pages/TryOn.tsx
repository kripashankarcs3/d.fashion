...
const garments: Garment[] = [
  ...
  { id:101, category:'Dresses', name:'White Summer Dress', img:'https://images.unsplash.com/photo-p9Ekz8XckR0?w=600&q=80', colourHex:'#FFFFFF', colourName:'White', buyUrl:'https://www.myntra.com/women/dresses/new arrivals/new arrivals' },
  { id:102, category:'Dresses', name:'Yellow Floral Dress', img:'https://images.unsplash.com/photo-HxyMA_7EDfM?w=600&q=80', colourHex:'#F4D03F', colourName:'Yellow', buyUrl:'https://www.myntra.com/women/dresses/new arrivals/new arrivals' },
  { id:103, category:'Dresses', name:'Maroon Floral Dress', img:'https://images.unsplash.com/photo-SJRgu1tfLlE?w=600&q=80', colourHex:'#800020', colourName:'Maroon', buyUrl:'https://www.myntra.com/women/dresses/new arrivals/new arrivals' },
  { id:104, category:'Dresses', name:'Blue Sleeveless Dress', img:'https://images.unsplash.com/photo-SU9boHH5nbE?w=600&q=80', colourHex:'#3498DB', colourName:'Blue', buyUrl:'https://www.myntra.com/women/dresses/new arrivals/new arrivals' },
  { id:105, category:'Dresses', name:'White Floral Dress', img:'https://images.unsplash.com/photo-aK6Z4aPdf5c?w=600&q=80', colourHex:'#FDEBD0', colourName:'Ivory', buyUrl:'https://www.myntra.com/women/dresses/new arrivals/new arrivals' },
  { id:106, category:'Dresses', name:'White Plaid Dress', img:'https://images.unsplash.com/photo-mJmxnpJTr8w?w=600&q=80', colourHex:'#FFFFFF', colourName:'White', buyUrl:'https://www.myntra.com/women/dresses/new arrivals/new arrivals' },
  { id:107, category:'Dresses', name:'Gray Crop Top Denim Outfit', img:'https://images.unsplash.com/photo-S0ZWPvX8XpU?w=600&q=80', colourHex:'#808080', colourName:'Gray', buyUrl:'https://www.myntra.com/women/dresses/new arrivals/new arrivals' },
  { id:108, category:'Dresses', name:'White Hallway Dress', img:'https://images.unsplash.com/photo-wdc6pMuRWyk?w=600&q=80', colourHex:'#F5F5F5', colourName:'White', buyUrl:'https://www.myntra.com/women/dresses/new arrivals/new arrivals' },

  // ── Tops — women's tops, blouses, shirts ─────────────────────────────────
  { id:201, category:'Tops', name:'White Long Sleeve Shirt', img:'https://images.unsplash.com/photo-WQgvRkmqRrg?w=600&q=80', colourHex:'#FFFFFF', colourName:'White', buyUrl:'https://www.ajio.com/women-tops-and-tees/c/830201013' },
  { id:202, category:'Tops', name:'Blue Checkered Shirt', img:'https://images.unsplash.com/photo-RqYTuWkTdEs?w=600&q=80', colourHex:'#3498DB', colourName:'Blue', buyUrl:'https://www.ajio.com/women-tops-and-tees/c/830201013' },
  { id:203, category:'Tops', name:'Black Blouse', img:'https://images.unsplash.com/photo-wD6-BLQepzI?w=600&q=80', colourHex:'#1A1A1A', colourName:'Black', buyUrl:'https://www.ajio.com/women-tops-and-tees/c/830201013' },
  { id:204, category:'Tops', name:'Red Top', img:'https://images.unsplash.com/photo-Xs1i1bZjU9Y?w=600&q=80', colourHex:'#E74C3C', colourName:'Red', buyUrl:'https://www.ajio.com/women-tops-and-tees/c/830201013' },
  ...
  { id:206, category:'Tops', name:'Floral Print Blouse', img:'https://images.unsplash.com/photo-xCH1vlk-feA?w=600&q=80', colourHex:'#E8C4A0', colourName:'Multicolor', buyUrl:'https://www.ajio.com/women-tops-and-tees/c/830201013' },
  { id:207, category:'Tops', name:'Pink Floral Blouse', img:'https://images.unsplash.com/photo-UhBh6y_fQ1U?w=600&q=80', colourHex:'#F8BBD0', colourName:'Pink', buyUrl:'https://www.ajio.com/women-tops-and-tees/c/830201013' },
  { id:208, category:'Tops', name:'White Blazer', img:'https://images.unsplash.com/photo-tOPAaNFUB70?w=600&q=80', colourHex:'#FFFFFF', colourName:'White', buyUrl:'https://www.ajio.com/women-tops-and-tees/c/830201013' },
  { id:209, category:'Tops', name:'White Shirt with Jeans', img:'https://images.unsplash.com/photo-sjUgmthGSgg?w=600&q=80', colourHex:'#FFFFFF', colourName:'White', buyUrl:'https://www.ajio.com/women-tops-and-tees/c/830201013' },
  { id:210, category:'Tops', name:'Polka Dot Shirt', img:'https://images.unsplash.com/photo-fJtiLNa18qc?w=600&q=80', colourHex:'#FFFFFF', colourName:'White', buyUrl:'https://www.ajio.com/women-tops-and-tees/c/830201013' },
  { id:211, category:'Tops', name:'Light Blue Shirt', img:'https://images.unsplash.com/photo-u-4g3QnRHLo?w=600&q=80', colourHex:'#AED6F1', colourName:'Light Blue', buyUrl:'https://www.ajio.com/women-tops-and-tees/c/830201013' },
  { id:212, category:'Tops', name:'White Sleeveless Shirt', img:'https://images.unsplash.com/photo-g4nUezDE0Yg?w=600&q=80', colourHex:'#FFFFFF', colourName:'White', buyUrl:'https://www.ajio.com/women-tops-and-tees/c/830201013' },
  ...
  { id:302, category:'Bottoms', name:'Folded Blue Jeans', img:'https://images.unsplash.com/photo-9yoXrG6Er_g?w=600&q=80', colourHex:'#2E86C1', colourName:'Blue', buyUrl:'https://www.myntra.com/women/bottomwear' },
  ...
  { id:304, category:'Bottoms', name:'Dark Blue Jeans', img:'https://images.unsplash.com/photo-wNP79A-_bRY?w=600&q=80', colourHex:'#0E4D92', colourName:'Dark Blue', buyUrl:'https://www.myntra.com/women/bottomwear' },
  { id:305, category:'Bottoms', name:'White Shirt Blue Jeans Outfit', img:'https://images.unsplash.com/photo-0HQzYawVQSY?w=600&q=80', colourHex:'#2E86C1', colourName:'Blue', buyUrl:'https://www.myntra.com/women/bottomwear' },
  { id:306, category:'Bottoms', name:'Jeans on Rack', img:'https://images.unsplash.com/photo-j_3IlDX-6uQ?w=600&q=80', colourHex:'#1A237E', colourName:'Denim Blue', buyUrl:'https://www.myntra.com/women/bottomwear' },
  { id:307, category:'Bottoms', name:'Gray Distressed Pants', img:'https://images.unsplash.com/photo-e9z8_vDmoSo?w=600&q=80', colourHex:'#808080', colourName:'Gray', buyUrl:'https://www.myntra.com/women/bottomwear' },
  { id:308, category:'Bottoms', name:'Split-Side Denim Pants', img:'https://images.unsplash.com/photo-GycfRBqs-O4?w=600&q=80', colourHex:'#2E86C1', colourName:'Denim Blue', buyUrl:'https://www.myntra.com/women/bottomwear' },

  // ── Outerwear — jackets, coats, blazers ─────────────────────────────────
  { id:401, category:'Outerwear', name:'Beige Trench Coat', img:'https://images.unsplash.com/photo-Xn7GvimQrk8?w=600&q=80', colourHex:'#D2B48C', colourName:'Beige', buyUrl:'https://www.myntra.com/women/jackets-and-coats' },
  { id:402, category:'Outerwear', name:'Tan Belted Trench', img:'https://images.unsplash.com/photo-5vrque5NVHI?w=600&q=80', colourHex:'#C19A6B', colourName:'Tan', buyUrl:'https://www.myntra.com/women/jackets-and-coats' },
  { id:403, category:'Outerwear', name:'Yellow Winter Coat', img:'https://images.unsplash.com/photo-__Ef8XniGLY?w=600&q=80', colourHex:'#F4D03F', colourName:'Yellow', buyUrl:'https://www.myntra.com/women/jackets-and-coats' },
  { id:404, category:'Outerwear', name:'Black Dress Coat', img:'https://images.unsplash.com/photo-zu8HjlOZVvM?w=600&q=80', colourHex:'#1A1A1A', colourName:'Black', buyUrl:'https://www.myntra.com/women/jackets-and-coats' },
  { id:405, category:'Outerwear', name:'Gray Coat', img:'https://images.unsplash.com/photo-wsE7x-6rdNs?w=600&q=80', colourHex:'#808080', colourName:'Gray', buyUrl:'https://www.myntra.com/women/jackets-and-coats' },
  { id:406, category:'Outerwear', name:'Brown Dress Coat', img:'https://images.unsplash.com/photo-3EbASbuFCwU?w=600&q=80', colourHex:'#8B4513', colourName:'Brown', buyUrl:'https://www.myntra.com/women/jackets-and-coats' },
  { id:407, category:'Outerwear', name:'Red Jacket on Line', img:'https://images.unsplash.com/photo-L7MBmE1VbVg?w=600&q=80', colourHex:'#E74C3C', colourName:'Red', buyUrl:'https://www.myntra.com/women/jackets-and-coats' },
  { id:408, category:'Outerwear', name:'Beige Trench with Binoculars', img:'https://images.unsplash.com/photo-4TgqH34FzAo?w=600&q=80', colourHex:'#D2B48C', colourName:'Beige', buyUrl:'https://www.myntra.com/women/jackets-and-coats' },

  // ── Ethnic Wear — sarees, kurtis, ethnic dresses ────────────────────────
  { id:501, category:'Ethnic Wear', name:'Black Sari', img:'https://images.unsplash.com/photo-zeRngVZRPyU?w=600&q=80', colourHex:'#1A1A1A', colourName:'Black', buyUrl:'https://www.myntra.com/women/ethnic-wear/sarees' },
  { id:502, category:'Ethnic Wear', name:'Red Sari', img:'https://images.unsplash.com/photo-KFE22Lb6xHE?w=600&q=80', colourHex:'#E74C3C', colourName:'Red', buyUrl:'https://www.myntra.com/women/ethnic-wear/sarees' },
  { id:503, category:'Ethnic Wear', name:'Purple Ethnic Dress', img:'https://images.unsplash.com/photo-g6TAHSxHksA?w=600&q=80', colourHex:'#8E44AD', colourName:'Purple', buyUrl:'https://www.myntra.com/women/ethnic-wear/kurtis' },
  { id:504, category:'Ethnic Wear', name:'Blue Sari Dress', img:'https://images.unsplash.com/photo-b_ASfbC-Ze4?w=600&q=80', colourHex:'#3498DB', colourName:'Blue', buyUrl:'https://www.myntra.com/women/ethnic-wear/sarees' },
  { id:505, category:'Ethnic Wear', name:'Maroon Traditional Dress', img:'https://images.unsplash.com/photo-C2Y7V5erV9M?w=600&q=80', colourHex:'#800020', colourName:'Maroon', buyUrl:'https://www.myntra.com/women/ethnic-wear/kurtis' },
  { id:506, category:'Ethnic Wear', name:'Black White Sari', img:'https://images.unsplash.com/photo-T8tJiKEOXME?w=600&q=80', colourHex:'#1A1A1A', colourName:'Black White', buyUrl:'https://www.myntra.com/women/ethnic-wear/sarees' },
  { id:507, category:'Ethnic Wear', name:'Yellow Floral Attire', img:'https://images.unsplash.com/photo-vBHjVNQtJYw?w=600&q=80', colourHex:'#F4D03F', colourName:'Yellow', buyUrl:'https://www.myntra.com/women/ethnic-wear/kurtis' },
  { id:508, category:'Ethnic Wear', name:'Blue Yellow Sari', img:'https://images.unsplash.com/photo-tjRs987fPfg?w=600&q=80', colourHex:'#3498DB', colourName:'Blue', buyUrl:'https://www.myntra.com/women/ethnic-wear/sarees' },
  { id:509, category:'Ethnic Wear', name:'Green Red Sari', img:'https://images.unsplash.com/photo--B_mXm2zQDs?w=600&q=80', colourHex:'#27AE60', colourName:'Green', buyUrl:'https://www.myntra.com/women/ethnic-wear/sarees' },
  { id:510, category:'Ethnic Wear', name:'Purple Pink Sari Group', img:'https://images.unsplash.com/photo-oXm1bSl87WY?w=600&q=80', colourHex:'#8E44AD', colourName:'Purple', buyUrl:'https://www.myntra.com/women/ethnic-wear/sarees' },
  { id:511, category:'Ethnic Wear', name:'Green Orange Sari', img:'https://images.unsplash.com/photo-vaWRPp-ieMw?w=600&q=80', colourHex:'#27AE60', colourName:'Green', buyUrl:'https://www.myntra.com/women/ethnic-wear/sarees' },
  { id:512, category:'Ethnic Wear', name:'Yellow Blue Sari', img:'https://images.unsplash.com/photo-sUGCCOdKKUY?w=600&q=80', colourHex:'#F4D03F', colourName:'Yellow', buyUrl:'https://www.myntra.com/women/ethnic-wear/sarees' },
  { id:513, category:'Ethnic Wear', name:'Colorful Traditional Dress', img:'https://images.unsplash.com/photo-8g8JB2ZaZKc?w=600&q=80', colourHex:'#E8C4A0', colourName:'Multicolor', buyUrl:'https://www.myntra.com/women/ethnic-wear/kurtis' },
  { id:514, category:'Ethnic Wear', name:'Floral Kurti', img:'https://images.unsplash.com/photo-DtpymKtGHek?w=600&q=80', colourHex:'#1A1A1A', colourName:'Black White', buyUrl:'https://www.myntra.com/women/ethnic-wear/kurtis' },
  { id:515, category:'Ethnic Wear', name:'Casual Kurtas', img:'https://images.unsplash.com/photo-Ln7tmteMELM?w=600&q=80', colourHex:'#E8C4A0', colourName:'Beige', buyUrl:'https://www.myntra.com/women/ethnic-wear/kurtis' },
];
